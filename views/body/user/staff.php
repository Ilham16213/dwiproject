                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-bordered" style="margin-bottom: 30px;">
                                        ...
                                        <?php
                                            ...
                                            $sql = "SELECT * 
                                            FROM data_pengguna 
                                            WHERE akses NOT IN ('manajer', 'owner');";
                                        ...
                                        while($row = $result->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a type='button' class='btn btn-danger btn-sm' href='index.php?page=pengguna&status=staff&hapus=<?php echo $row['id_pengguna']; ?>' onclick='return confirmDelete()'>Hapus</a>
                                                </td>
                                                <?php } ?>
                                            </tr>
                                        <?php } ?>
